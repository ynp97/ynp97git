...
- 開くもの: `eBay-Record-Lister/index.html`
- 主なファイル: `index.html`, `styles.css`, `app.js`

### ynp97-todo-inbox

- 種別: TODOインボックス用Macアプリ
- 開くもの: `/Applications/TODOインボックス.app`
- ソース: `ynp97-todo-inbox`
- ビルド: `ynp97-todo-inbox/script/build_and_run.sh`
- 備考: TODOは `TODOインボックス.md` に自動書き出し。JSON本体は `~/Library/Application Support/ynp97 TODOインボックス/todo-data.json`。アイコンは正式採用済みの黄色地に太いTで、`ynp97-todo-inbox/script/make_icon.swift` から生成する。
