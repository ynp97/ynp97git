...
> **2026-09-06更新**：以下は7月の移設作業票として保存。本人の依頼でマイク内蔵録音を追加したため、「マイクを追加しない」「機能を変えない」は現在の開発には適用しない。最新仕様・実装・未完了の確認事項は [[アプリ引き継ぎ/U スクリーンレコーダー]] の末尾および `アプリ本体/screen-recorder/README.md` を参照。
